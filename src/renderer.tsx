  ...
  return (
    <html lang="zh-CN">
      <head>
        ...
        <title>JYC Verse · One Token. Every Thrill. — 全球最大的 Web3 娱乐宇宙</title>
        <meta name="description" content="JYC Verse:全球首个覆盖全部博彩人格的一站式 Web3 娱乐宇宙。预测、竞猜、赌场、彩票、玄学、竞技、卡牌、直播、元宇宙——12 大星域、170+ 玩法,只用一枚筹码:JYC。" />
        <meta property="og:title" content="JYC Verse · One Token. Every Thrill." />
        <meta property="og:description" content="12 大星域 · 170+ 玩法 · 1 枚代币。全球最大的 Web3 娱乐宇宙。" />
